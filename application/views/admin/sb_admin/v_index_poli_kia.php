...
// Query untuk menghitung jumlah antrian_poli dengan kode_poli 'PLKIA'
$countSql = "SELECT COUNT(*) AS jumlah_antrian_poli
             FROM antrian_poli
             JOIN kategori_poli ON antrian_poli.id_poli = kategori_poli.id_poli
             WHERE DATE(antrian_poli.tgl_antrian_poli) = '$currentDate'
               AND kategori_poli.kode_poli = 'PLKIA'";
...
// Query untuk mencari nomor antrian_poli sekarang (nomor antrian_poli tertinggi) dengan kode_poli 'PLKIA'
...
// Query untuk mencari nomor antrian_poli selanjutnya dengan kode_poli 'PLKIA'
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <h2 class="mb-4">Antrian Poli KIA</h2>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="text-center">
                                        <div class="huge">
                                            <?php
                                            // Query untuk menghitung jumlah antrian_poli yang prosesnya == 0 dan kode_poli == 'PLKIA'
                                            $countProses0Sql = "
          ...
          AND kategori_poli.kode_poli = 'PLKIA'";
                ...
                <div class="container mt-5">
                    <table class="">
                        <thead class="hidden">
                            <tr>
                                <th class="text-center">Nomor Antrian Poli KIA</th>
                        ...
                        <tbody class="text-center">
                            <?php if ($result->num_rows > 0) : ?>
                                ...
                                while ($row = $result->fetch_assoc()) :
                                    if ($row["proses"] == 0 && $row["kode_poli"] == "PLKIA") :
                        ...
                        if (isset($_POST['kirimPesan'])) {
                            ...
                            $pesan = "Halo $namaPasien,\n\n"
                                . "Kami dari Puskesmas Buntu Batu ingin memberitahukan bahwa nomor Antrian Poli KIA Anda, $noAntrian_poli, telah dipanggil.\n\n"
                        ...
                        if (isset($_POST['kirimPesan'])) {
                            ...
                            $pesan = "Halo $namaPasien,\n\n"
                                . "Ini adalah pemberitahuan penting dari Puskesmas Buntu Batu. Nomor antrian Poli KIA Anda, $noAntrian_poli, akan segera dipanggil di Poli KIA.\n\n"
                ...
                <script>
                    document.getElementById('callAntrianBtn').addEventListener('click', function() {
                        ...
                        if (nomorAntrian_poliSekarang !== '0') {
                            ...
                            msg.text = "Dipanggil Sekali Lagi Untuk Nomor antrian " + nomorAntrian_poliSekarang + ", silakan ke Poli Kesehatan Ibu Dan Anak";
    ...
    <script>
        function callAndProcess(params) {
            ...
            const msg = new SpeechSynthesisUtterance();
            msg.text = "Nomor antrian poli " + nomorAntrian_poli + ", silakan ke Poli Kesehatan ibu dan anak";
            window.speechSynthesis.speak(msg);
