...
// Query untuk menghitung jumlah antrian_poli dengan kode_poli 'PLUM'
$countSql = "SELECT COUNT(*) AS jumlah_antrian_poli
             FROM antrian_poli
             JOIN kategori_poli ON antrian_poli.id_poli = kategori_poli.id_poli
             WHERE DATE(antrian_poli.tgl_antrian_poli) = '$currentDate'
               AND kategori_poli.kode_poli = 'PLUM'";
...
// Query untuk mencari nomor antrian_poli sekarang (nomor antrian_poli tertinggi) dengan kode_poli 'PLUM'
...
// Query untuk mencari nomor antrian_poli selanjutnya dengan kode_poli 'PLUM'
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <h2 class="mb-4">Antrian Poli Umum</h2>
                <br>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="text-center">
                                        <div class="huge">
                                            <?php
                                            // Query untuk menghitung jumlah antrian_poli yang prosesnya == 0 dan kode_poli == 'PLUM'
                                            $countProses0Sql = "
          ...
          AND kategori_poli.kode_poli = 'PLUM'";
                ...
                <div class="container mt-5">
                    <table class="">
                        <thead class="hidden">
                            <tr>
                                <th class="text-center">Nomor Antrian Poli Umum</th>
                        ...
                        <tbody class="text-center">
                            <?php if ($result->num_rows > 0) : ?>
                                ...
                                while ($row = $result->fetch_assoc()) :
                                    if ($row["proses"] == 0 && $row["kode_poli"] == "PLUM") :
                        ...
                        if (isset($_POST['kirimPesan'])) {
                            ...
                            $pesan = "Halo $namaPasien,\n\n"
                                . "Kami dari Puskesmas Buntu Batu ingin memberitahukan bahwa nomor Antrian Poli Umum Anda, $noAntrian_poli, telah dipanggil.\n\n"
                        ...
                        if (isset($_POST['kirimPesan'])) {
                            ...
                            $pesan = "Halo $namaPasien,\n\n"
                                . "Ini adalah pemberitahuan penting dari Puskesmas Buntu Batu. Nomor antrian Poli Umum Anda, $noAntrian_poli, akan segera dipanggil di Poli Umum.\n\n"
                ...
                <script>
                    document.getElementById('callAntrianBtn').addEventListener('click', function() {
                        ...
                        if (nomorAntrian_poliSekarang !== '0') {
                            ...
                            msg.text = "Dipanggil Sekali Lagi Untuk Nomor antrian " + nomorAntrian_poliSekarang + ", silakan ke Poli Umum";
    ...
    <script>
        function callAndProcess(params) {
            ...
            const msg = new SpeechSynthesisUtterance();
            msg.text = "Nomor antrian poli " + nomorAntrian_poli + ", silakan ke poli umum";
            window.speechSynthesis.speak(msg);
