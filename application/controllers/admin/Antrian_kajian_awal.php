...
class Antrian_kajian_awal extends Super
{
    ...
    function __construct()
    {
        ...
        $this->active_id_menu = "Antrian kajian awal";
        $this->nama_view      = "Antrian kajian awal";
        $this->status         = true;
    ...
    function index()
    {
        ...
        $this->load->view('admin/' . $this->session->userdata('theme') . '/v_index_antrian', $data);
    }
