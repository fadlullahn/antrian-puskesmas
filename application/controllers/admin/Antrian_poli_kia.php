...
class Antrian_poli_kia extends Super
{
    ...
    function __construct()
    {
        ...
        $this->active_id_menu = "Antrian poli kia";
        $this->nama_view      = "Antrian poli kia";
        $this->status         = true;
    ...
    function index()
    {
        ...
        $this->load->view('admin/' . $this->session->userdata('theme') . '/v_index_poli_kia', $data);
    }
